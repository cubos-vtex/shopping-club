📢 Use this project, [contribute](https://github.com/cubos-vtex/shopping-club) to it or open issues to help evolve it using [repository issues](https://github.com/cubos-vtex/shopping-club/issues).
